      ...
      {isVisible && (
        <motion.header initial={{ y: -80, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: -80, opacity: 0 }} transition={{ duration: 0.3, ease: 'easeOut' }}
          ...
          <div className="max-w-6xl mx-auto px-4 py-2 flex items-center justify-between">
            <a href="https://giabaobooks.vn" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
              <img src="/Logo.png" alt="GiaBaoBooks" className="h-9 w-auto object-contain" />
            </a>
